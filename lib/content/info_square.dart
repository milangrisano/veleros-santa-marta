...
List<InfoSquare> squareContent = [
  ...
  InfoSquare(
    ...
    descripcion: "Disfruta de las mas hermosas playas de Santa Marta y del parque Tayrona, de los mas imponentes paisajes, del mar mas azul y de la vista mas privilegiada de la sierra nevada Colombiana",
  ),
];